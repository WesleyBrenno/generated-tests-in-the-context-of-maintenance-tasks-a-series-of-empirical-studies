...
public abstract class ListPopulation implements Population {
	...
	/**
	 * Creates a new ListPopulation instance and initializes its chromosome list
	 * to the empty list. Relies on {@link #ListPopulation(List, int)} to
	 * initialize and handle exceptions.
	 *
	 ...
	 * <p>
	 * Note: this method removes all existing chromosomes in the population and
	 * adds all chromosomes of the specified list to the population.
	 *
	 * @param chromosomes
	...
	/**
	 * Add a {@link Collection} of chromosomes to this {@link Population}, e.g.,
	 * via {@link List#addAll(Collection)}.
	 * 
	...
	/**
	 * Returns an unmodifiable list of the chromosomes in this population, e.g.,
	 ...
	 * @throws NumberIsTooLargeException
	 *             if the population would exceed the {@code populationLimit}
	...
	/**
	 * Access the fittest chromosome in this population. Two chromosomes are
	 * compared with a call to {@link Chromosome#compareTo(Chromosome)}, and the
	 * fitter chromosome of a comparison has a higher fitness value, i.e.,
	 * <code>chromosome1.compareTo(chromosome2)</code> returns 1 if
	 * <code>chromosome1</code> is fitter than <code>chromosome2</code>.
	 * 
	 * {@link Chromosome#compareTo(Chromosome)}
	 *
	 * @throws IndexOutOfBoundsException
	 *             if list of chromosomes is empty
